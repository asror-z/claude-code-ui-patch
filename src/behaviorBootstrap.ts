...
(function () {
  ...
  */
  ...
  var FOOTPRINT = {
    ...
    multiselect:  { hide: [".cc-multiselect-chk", "[data-cc-tool='multiselect']"] },
    ...
    scroll:       { hide: [".cc-scroll-top", ".cc-scroll-bottom", "[data-cc-tool='scroll-top']", "[data-cc-tool='scroll-bottom']"] },
